...
void createVetRot(double vetRot[]) {
    /* Declare intial variables for rotation vector */
...
double sumEnergia(struct particula part[], int NUM) {
...
void printParticula(FILE* arquivo, struct particula particulas[],
                    double diam, int NUM) {
...
/* accept an iteration accordind to Metropolis' Algorithm */
bool aceitaIteracao(double energia, double energiaAtual, double temperatura) {
...
void copiaStruct(struct particula origem[], struct particula destino[],
		 int size) {
